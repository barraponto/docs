...
* [custom `SystemMessage`s](/oss/python/langchain/middleware/custom#working-with-system-messages): Support for passing `SystemMessage` instances directly to `system_prompt` parameter, enabling advanced features like cache control and structured content blocks.
...
- [V1 Release notes](/oss/python/python/releases/langchain-v1) - Detailed release notes
