...
You can modify system prompts in middleware using either `system_prompt` (`string`) or `system_message` ([`SystemMessage`](https://reference.langchain.com/python/langchain/messages/#langchain.messages.SystemMessage)). The [`ModelRequest`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.ModelRequest) provides both for maximum flexibility.
